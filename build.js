        ...
        'dashboard': {
            ...
            plugins: [
                esbuildProblemMatcherPlugin,
                {
                    ...
                    setup(build) {
                        build.onEnd(async () => {
                            const outDir = path.join(__dirname, path.dirname(build.initialOptions.outfile));
                            const srcDir = path.join(__dirname, path.dirname(build.initialOptions.entryPoints[0]));
